                      ...
                      {showFullRubric && fullRubricRows.length > 0 ? (
                        <div style={{ overflowX: "auto" }}>
                          ...
                          >
                            <thead>
                              <tr>
                                <th style={fullRubricHeaderStyle}>Level</th>
                                <th style={fullRubricHeaderStyle}>KNOW</th>
                                <th style={fullRubricHeaderStyle}>DO</th>
                                <th style={fullRubricHeaderStyle}>UNDERSTAND</th>
                              </tr>
                            </thead>
                            <tbody>
                              {fullRubricRows.map((row) => (
                                <tr key={row.level}>
                                  <td style={fullRubricCellStyle}>
                                    <strong>{row.level}</strong>
                                  </td>
                                  <td style={fullRubricCellStyle}>{row.know || ""}</td>
                                  <td style={fullRubricCellStyle}>{row.do || ""}</td>
                                  <td style={fullRubricCellStyle}>{row.understand || ""}</td>
                                </tr>
                              ))}
                            </tbody>
                          </table>
