...
function ReportsPage() {
  ...
  function goToDashboardSafely() {
    if (
      hasUnsavedCommentChanges &&
      !window.confirm("You have unsaved report comment changes. Leave without waiting for autosave?")
    ) {
      return;
    }
  ...
  function saveComment(studentUserId, com1, com2) {
    ...
    .then(() => {
      ...
      setSavedCommentStudentId(studentUserId);
      setHasUnsavedCommentChanges(false);
      ...
      setCommentSaveTimes((current) => ({
        ...current,
        [studentUserId]: formattedTime,
      }));
              ...
              {reportComments.map((student) => (
                <tr key={student.student_user_id}>
                  ...
                  <td style={tdStyle}>
                    <textarea
                      ...
                      onChange={(e) => {
                        ...
                        setHasUnsavedCommentChanges(true);
                  ...
                  <td style={{ ...tdStyle, position: "relative" }}>
                    ...
                    {commentSaveTimes[student.student_user_id] ? (
                      <div style={commentTimestampStyle}>
                        Last saved: {commentSaveTimes[student.student_user_id]}
                      </div>
                    ) : null}
                  </td>
                </tr>
