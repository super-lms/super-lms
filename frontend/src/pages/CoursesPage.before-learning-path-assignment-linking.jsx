...
export default function CoursesPage() {
  ...
  async function saveLearningPathItem(learningPathId, item) {
    ...
    try {
      ...
      if (!res.ok) {
        throw new Error(data.error || "Failed to save Learning Path item")
      }
  ...
  async function deleteLearningPathItem(learningPathId, item) {
    ...
    try {
      ...
      if (!res.ok) {
        throw new Error(data.error || "Failed to delete Learning Path item")
      }
                                              ...
                                              {isEditing ? (
                                                <div style={{ display: "grid", gap: "10px" }}>
                                                  ...
                                                  <div>
                                                    ...
                                                    <input
                                                      ...
                                                      onChange={(event) =>
                                                        updateItemDraft(item.id, "resource_url", event.target.value)
                                                      }
                                                ...
                                                <>
                                                  ...
                                                  <div style={{ display: "flex", gap: "8px", flexWrap: "wrap" }}>
                                                    <button
                                                      type="button"
                                                      onClick={() => startEditingLearningPathItem(item)}
                                                      style={buttonStyle}
                                                    >
                                                      Edit
                                                    </button>
