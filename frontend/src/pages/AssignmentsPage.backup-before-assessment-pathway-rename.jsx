  ...
  async function handleSetupKduStructure() {
    ...
    try {
      const response = await fetch(
        `http://localhost:3000/api/courses/${selectedClassId}/setup-kdu-assessment-structure`,
        {
          method: "POST",
          headers: {
            ...
            >
              ...
              >
                <div style={{ display: "grid", gap: "10px", fontSize: "0.95rem", lineHeight: 1.5 }}>
                  ...
                  <div>
                    <strong>Learning Category:</strong> {deleteTargetAssignment.category_name || "Not linked"}
                  </div>
                  <div>
                ...
                <div ref={createSectionRef}>
                  <DetailCard title="Create Assignment">
                    {!classHasCategories ? (
                      <NoticeBox>
                        <div style={{ display: "grid", gap: "12px" }}>
                          <div>
                            This class does not have learning categories available yet. Create learning categories and evidence tiers before creating competency-linked assignments.
                          </div>
                          <div>
                            <ActionButton
                              type="button"
                    ...
                    <form onSubmit={createAssignment}>
                      ...
                      >
                        <div style={{ display: "grid", gap: "14px" }}>
                          <InputBlock label="Learning Category">
                            <select
                        ...
                        <div>
                          <DetailCard title="Assignment Weight Preview">
                            <div style={{ display: "grid", gap: "12px" }}>
                              <div>
                                <strong>Selected Learning Category:</strong>{" "}
                              ...
                              <div>
                                ...
                                {previewCalculatedWeight === null ? "Select learning category and subcategory" : formatPercent(previewCalculatedWeight)}
                              </div>
                            </div>
                          </DetailCard>
                        </div>
                          ...
                          return (
                            <DetailCard key={assignment.id} title={assignment.title}>
                              <div style={{ display: "grid", gap: "8px" }}>
                                ...
                                <div>
                                  <strong>Learning Category:</strong> {assignment.category_name || "Not linked"}
                                </div>
                                <div>
