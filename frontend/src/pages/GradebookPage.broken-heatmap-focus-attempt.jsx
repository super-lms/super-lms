...
export default function GradebookPage() {
  ...
  useEffect(() => {
    ...
    const targetId = `student-row-${String(requestedStudentEmail || requestedStudentName)
      .toLowerCase()
      .replace(/[^a-z0-9]+/g, "-")}`;
              ...
              <table>
                ...
                <tbody>
                  {students.map((student) => {
                    const studentMatchesFocus =
                      (requestedStudentEmail &&
                        String(student.student_email || "").toLowerCase() ===
                          String(requestedStudentEmail || "").toLowerCase()) ||
                      (requestedStudentName &&
                        String(student.student_name || "").toLowerCase() ===
                          String(requestedStudentName || "").toLowerCase());

                    const studentFocusId = `student-row-${String(
                      requestedStudentEmail || requestedStudentName || student.student_email || student.student_name
                    )
                      .toLowerCase()
                      .replace(/[^a-z0-9]+/g, "-")}`;
                    ...
                    <tr
                      ...
                      id={studentMatchesFocus ? studentFocusId : undefined}
                      style={
                        studentMatchesFocus
                          ? {
                            ...
                            <td>
                              ...
                              {studentMatchesFocus ? (
                                <div style={focusBadgeStyle}>
                                  Heatmap focus{requestedFocus ? `: ${requestedFocus}` : ""}
                                </div>
                              ) : null}
                            </td>
                              ...
                              return (
                                <td key={assignment.id} style={{ minWidth: "260px" }}>
                                  ...
                                  <div style={{ display: "grid", gap: "14px" }}>
                                    <div
                                      style={
                                        requestedFocus === "DO" && studentMatchesFocus
                                          ? focusedKduBoxStyle
                                          : {}
                                      }
                                    >
                                    ...
                                    <div
                                      style={
                                        requestedFocus === "KNOW" && studentMatchesFocus
                                          ? focusedKduBoxStyle
                                          : {}
                                      }
                                    >
                                    ...
                                    <div
                                      style={
                                        requestedFocus === "UNDERSTAND" && studentMatchesFocus
                                          ? focusedKduBoxStyle
                                          : {}
                                      }
                                    >
