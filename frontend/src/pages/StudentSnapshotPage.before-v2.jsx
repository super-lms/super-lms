          ...
          <div style={{ display: "grid", gap: "18px", maxWidth: "1120px" }}>
              ...
              {Array.isArray(student.group_breakdown) && student.group_breakdown.length > 0 ? (
                <div style={{ display: "grid", gap: "10px" }}>
                  {student.group_breakdown.map((group) => (
                    <div key={group.subcategory_id} style={rowStyle}>
                      <div>
            ...
            <section style={sectionStyle}>
              ...
              <p style={{ color: "#4b5563", lineHeight: 1.6, marginBottom: 0 }}>
                This read-only snapshot shows current course standing, assignment results,
                teacher feedback, and how evidence contributes to the course grade. Future
                versions can become the student portal and parent portal using the same foundation.
              </p>
            </section>
          </div>
        )}
