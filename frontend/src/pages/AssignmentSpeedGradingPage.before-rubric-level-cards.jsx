    ...
    try {
      ...
      const res = await fetch(`${API_BASE}/api/assignments/${assignmentId}/kdu-scores`, {
        ...
        body: JSON.stringify({
          ...
          doScore: toSafeScore(doScore),
          knowScore: toSafeScore(knowScore),
          understandScore: toSafeScore(understandScore),
        }),
      });
      ...
      setKduSaveMessage("KDU scores saved for this student.");
      await loadGradebook();
    } catch (error) {
                          ...
                          {fullRubricRows.map((row) => (
                            <div key={row.level} style={fullRubricLevelCardStyle}>
                              ...
                              <div style={fullRubricDescriptorGridStyle}>
                                <div style={fullRubricDescriptorBoxStyle}>
                                  <div style={{ fontWeight: 800, marginBottom: "6px" }}>
                                    KNOW
                                  </div>
                                  ...
                                  <ActionButton
                                    quiet
                                    onClick={() => {
                                      setKnowScore(String(row.level));
                                      setKduSaveMessage(`KNOW set to Level ${row.level}. You can adjust the decimal score if needed.`);
                                    }}
                                  >
                                ...
                                <div style={fullRubricDescriptorBoxStyle}>
                                  ...
                                  <ActionButton
                                    quiet
                                    onClick={() => {
                                      setDoScore(String(row.level));
                                      setKduSaveMessage(`DO set to Level ${row.level}. You can adjust the decimal score if needed.`);
                                    }}
                                  >
                                    Set DO to {row.level}
                                  </ActionButton>
                                ...
                                <div style={fullRubricDescriptorBoxStyle}>
                                  ...
                                  <ActionButton
                                    quiet
                                    onClick={() => {
                                      setUnderstandScore(String(row.level));
                                      setKduSaveMessage(`UNDERSTAND set to Level ${row.level}. You can adjust the decimal score if needed.`);
                                    }}
                                  >
