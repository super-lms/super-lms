...
export default function AssignmentSpeedGradingPage() {
  ...
  useEffect(() => {
    function handleKeyboardShortcut(event) {
      ...
      if (shortcutBucket === "KNOW") {
        ...
        saveKduScores({ knowScore: nextScore }, { bucket: "KNOW", level: nextScore });
      ...
      if (shortcutBucket === "DO") {
        ...
        saveKduScores({ doScore: nextScore }, { bucket: "DO", level: nextScore });
        setShortcutBucket(null);
        return;
      }
      ...
      if (shortcutBucket === "UNDERSTAND") {
        ...
        saveKduScores({ understandScore: nextScore }, { bucket: "UNDERSTAND", level: nextScore });
        setShortcutBucket(null);
        return;
      }
  ...
  async function saveKduScores(scoreOverrides = {}, toastTarget = null) {
